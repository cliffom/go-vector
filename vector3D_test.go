...
func TestNewVector3D(t *testing.T) {
	v1 := vector.Vector3D{3, 4, 0}
	v2 := vector.NewVector3D(3, 4, 0)

	vSum := v1.Subtract(v2)
	vz := vector.Vector3D{0, 0, 0}
...
func TestNormalize(t *testing.T) {
	v := vector.Vector3D{3, 4, 0}
	expected := vector.Vector3D{0.6, 0.8, 0.0}
...
func TestAdd(t *testing.T) {
	v1 := vector.Vector3D{3, 4, 5}
	v2 := vector.Vector3D{1, 2, 3}
	expected := vector.Vector3D{4, 6, 8}
	result := v1.Add(v2)
	if result != expected {
...
func TestSubtract(t *testing.T) {
	v1 := vector.Vector3D{3, 4, 5}
	v2 := vector.Vector3D{1, 2, 3}
	expected := vector.Vector3D{2, 2, 2}
...
func TestMultiply(t *testing.T) {
	...
	scalar := 2.0
	expected := vector.Vector3D{6, 8, 10}
...
func TestCrossProduct(t *testing.T) {
	v1 := vector.Vector3D{3, -3, 1}
	v2 := vector.Vector3D{4, 9, 2}
	expected := vector.Vector3D{-15, -2, 39}
...
func TestDistance(t *testing.T) {
	v1 := vector.Vector3D{1, 2, 3}
	v2 := vector.Vector3D{4, 5, 6}
